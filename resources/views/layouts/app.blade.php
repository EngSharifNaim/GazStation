...
{{--    <link href="https://fonts.googleapis.com/css?family=Roboto:400,300,100,500,700,900" rel="stylesheet" type="text/css">--}}
    <script src="https://use.fontawesome.com/82d5d32cce.js"></script>
...
<div class="navbar navbar-expand-md navbar-dark">
    <div class="navbar-brand">
        <a href="{{url('home')}}" class="d-inline-block">
            <img src="global_assets/images/logo_light.png" alt="" style="height: 150%;width: 100%">
        </a>
    </div>
        ...
        <div class="navbar navbar-expand-lg navbar-light fixed-bottom">
            ...
            <div class="navbar-collapse collapse" id="navbar-footer">
                ...
                <ul class="navbar-nav ml-lg-auto">
                    <li class="nav-item"><a href="#" class="navbar-nav-link" target="_blank"><i class="icon-lifebuoy mr-2"></i> مبيعات اليوم بالجرة : </a></li>
                    <li class="nav-item"><a href="#" class="navbar-nav-link" target="_blank"><i class="icon-file-text2 mr-2"></i> مبيعات اليوم بالكيلو : </a></li>
