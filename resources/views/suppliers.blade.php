            ...
            <div class="page-header-content header-elements-inline">
                <div class="page-title">
                    <h5>
                        ...
                        <span class="font-weight-semibold">صفحة الموردين</span>
                        <small class="d-block text-muted">الاجمالي : {{count($suppliers)}}</small>
                    </h5>
                </div>

                <div class="header-elements d-flex align-items-center">
                    <button class="btn btn-primary" data-toggle="modal" data-target="#modal_theme_info_supplier">مورد جديد <i class="icon-user-plus"></i></button>
                </div>
            </div>
